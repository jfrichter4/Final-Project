...
"""
Zip1 = zip("A+", "A", "A-", "B+", "B", "B-", "C+", "C", "C-", "D+", "D", "D-", "F+", "F", "F-", "U", "N/A")
Zip2 = zip(4, 4, 3.67, 3.33, 3, 2.67, 2.33, 2, 1.67, 1.33, 1, .67, .33, 0)
Total = sum("A", "B", "C", "D", "E", "F", "G", "H")
Final = Total/J
if Final > 3.7:
    print("You are above average - your GPA is " + Final + "!")
if Final < 3.7:
    print("You are below average - your GPA is " + Final + "!")
